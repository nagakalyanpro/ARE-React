  ...
  return (
    <section>
      <body class="bg">
                      ...
                      <div class="swiper-container">
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="claims-text bg-white">
                              <p>&nbsp;</p>
                              <p class="title">Claim Processor</p>
                            </div>
                            <div class="card-stripe-blue">
                              <ul>
                                <li>Users</li>
                                <li>Common Roles</li>
                            ...
                            <div class="card-stripe-white pb-4">
                              <ul>
                                <li>12</li>
                                <li>5-12%</li>
                                <li>3-8%</li>
                      ...
                      <div class="col-lg-6">
                        <div class="card card-square box-shadow-none">
                          <div class="card-body p-0">
                            <div class="justify-content-between align-items-center light-color-bg">
                              <div>
                            ...
                            <div class="scroll-div custom-scrollbar">
                              <div class="p-4">
                                <a
                                  href="#"
                                  class="w-100 d-flex text-decoration-none text-dark mb-3"
                                >
                                  Team Member
                                </a>
                                <a
        ...
        <script src="assets/https://cdnjs.cloudflare.com/ajax/libs/Swiper/3.4.1/js/swiper.min.js"></script>
